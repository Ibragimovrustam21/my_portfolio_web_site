...
export const HomePage = () => {
  return (
    <div className='content home-page'>
      ...
      <p {...animateUp} data-aos-duration="1000">Я Фронтенд разработчик, специализирующийся на создании адаптивных веб-сайтов.В настоящее время работая над собой.Моя цель создать веб-сайты, которые принесут пользу людям.</p>
